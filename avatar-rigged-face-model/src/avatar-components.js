  ...
  const magnetComponent = {
    init() {
      this.el.insertAdjacentHTML('beforeend', `
        <a-entity scale="0.033 0.025 0.025">
          <a-box position="-1 0 -.5" color="#00EDAF"></a-box>
          <a-box position="0 0 -.5" color="#D9D0E3"></a-box>
          <a-box position="1 0 -.5" color="#DD0065"></a-box>
          <a-box position="-1 0 .5" color="#7611B6"></a-box>
          <a-box position="0 0 .5" color="#FFC828"></a-box>
          <a-box position="1 0 .5" color="#2D2E43"></a-box>
          <a-box position="0 -0.51 0" scale="3 .01 2" color="#000000"></a-box>
        </a-entity>
        `)
    },
  }
